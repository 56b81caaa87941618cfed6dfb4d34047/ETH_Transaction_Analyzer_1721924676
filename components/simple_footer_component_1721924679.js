...
*/
Vue.component("simple_footer_component_1721924679", {
    template: `
                ...
                <div id="footer-content" class="text-center">
                    <div class="flex">
                        <a id="footer-logo-link" href="#" class="flex-1 flex items-center justify-center mb-5 text-2xl font-semibold text-gray-900 dark:text-white">
                            ...
                            EtherScan - Ethereum Transaction Analyzer
                        </a>
                    </div>
                </div>
                <div class="flex">
                    <div id="footer-text" class="flex-1 block text-sm text-center text-gray-500 dark:text-gray-400">
                        Stay up-to-date with the latest Ethereum transactions. EtherScan provides real-time analysis and monitoring of new transactions on the Ethereum blockchain. Gain valuable insights into token transfers, smart contract deployments, and more.
                    </div>
                </div>
            </div>
        </footer> 
